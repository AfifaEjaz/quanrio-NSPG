...
import electric from "../assets/images/electric_icon.png";
import hvac from "../assets/images/HVAC-icon.png";
import heat from "../assets/images/heat-icon.png";
import ac from "../assets/images/ac-icon.png";
import chimney from "../assets/images/chimney-icon.png";
